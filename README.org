...
#+BEGIN_SRC shell :var zmk_path="../zmk"
  ...
  docker exec zmk west build -p -s /app -d /app/build/pepesweep/left/ --board nice_nano -- -DSHIELD=pepesweep_left -DZMK_CONFIG=/zmk-config/config
  docker exec zmk west build -p -s /app -d /app/build/pepesweep/right/ --board nice_nano -- -DSHIELD=pepesweep_right -DZMK_CONFIG=/zmk-config/config
...
[[file:keymap-drawer/cradio.svg][Sweep Layout]]

*** Pepesweep:

[[file:keymap-drawer/pepesweep.svg][Pepesweep layout]]
